(function() {
    ...
    t.set(blueWipe, {x:770});
    t.set(ladderHide, {x:-305});
    ...
    t.to(blueWipe, 1, {x:"-=770", ease: Power3.easeOut, delay:4});

    t.to(copy03, 1, { autoAlpha:1, ease: Power3.easeOut, delay:5});
    t.to([copy01, copy02], 1, {autoAlpha:0, ease: Power2.easeInOut, delay:6})

    t.to(blueWipe, .5, { x:450, ease: Power2.easeInOut, delay:7});

    t.to(container, .5, { x:900, ease: Power2.easeInOut, delay:7});
