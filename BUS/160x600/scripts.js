(function() {
    ...
    //intro frame 01
        ...
        t.to(blueWipe, 1, {x:"-=115", ease: Power3.easeOut, delay:2});
        ...
        t.to(copy04, 1, { autoAlpha:1, ease: Power3.easeOut, delay:3.4});
        t.from(copy04, 1, { y:"+=20",  rotation: .01, willChange: "transform", force3D:true, ease: Power3.easeOut, delay:3.4});

        t.to(copy05, 1, { autoAlpha:1, ease: Power3.easeOut, delay:3.7});
        t.from(copy05, 1, { y:"+=20",  rotation: .01, willChange: "transform", force3D:true, ease: Power3.easeOut, delay:3.7});

        t.to(copy06, 1, { autoAlpha:1, ease: Power3.easeOut, delay:4.5});
        //t.from(copy04, 1, { y:"+=15",  rotation: .01, willChange: "transform", force3D:true, ease: Power3.easeOut, delay:6.5});



        t.to(blueWipe, .5, { x:115, ease: Power2.easeInOut, delay:7.5});
